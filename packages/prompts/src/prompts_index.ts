...
const TRENDS_BASE = (marketName: string, mediaLine: string, audienceLine: string) => `\
You are a B2B Marketing Strategist who has been working in ${marketName} for 12 years. \
